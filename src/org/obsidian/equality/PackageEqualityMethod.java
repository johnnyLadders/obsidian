 ...
 *
 */
public class PackageEqualityMethod {
    ...
    public PackageEqualityMethod(String classType){
        ...
        equalityMethod.append("\n\t");
        equalityMethod.append("static boolean "
        ...
        //return
        equalityMethod.append("\n\t\treturn GlobalEqualityMethods.areEqual(valueOne,valueTwo);");
    ...
    public PackageEqualityMethod(String classType, String contents){
        this.classType = classType;
